					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								...
								<img style="width: 200px;" class="mainImage" src="{{asset('/images/backend_images/products/medium/'.$productDetail->image)}}" alt="" /></a> 
								</div>
							</div>
								  ...
								  <!-- Wrapper for slides -->
								    ...
								    <div class="carousel-inner"> 
										...
										<a href="{{asset('images/backend_images/products/large'.$altimage->image)}}" data-standard="{{asset('images/backend_images/products/small'.$altimage->image)}}">
										 <img class="changeImage" src="{{asset('images/backend_images/products/small'.$altimage->image)}}" alt="img" style="width: 80px; cursor: pointer;"></a>
										 @endforeach
										</div> 	
						          	</div>
							       </div>
						...
						<div class="col-sm-7">
							<form name="cartForm" method="post" action="{{url('add-cart')}}">
								{{csrf_field()}}
							...
							<inpuut type="hidden" name="size" value="{{$productDetail->size}}">
							...
							<div class="product-information"><!--/product-information-->
								...
								<p>
									<select name="size" style="width: 120px;" id="<!-- selSize -->">
								...
								<span>
									<span id="getPrice">INR {{$productDetail->price}}</span>
								...
								<p><b>Availability:</b>@if($stock_prod>0) In Stock @else Out of stock @endif</p>
